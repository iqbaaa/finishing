                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel">Form Ubah proabah</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="<?= site_url('Produk/edit') ?>" method="POST" role="form" enctype="multipart/form-data">
                                                                <div class="form-group">
                                                                    <label for="">Merk</label>
                                                                    <input class="form-control" type="text" value="<?= $pro->merkProduk ?>" name="merkProduk" placeholder="" />
                                                                    <input type="hidden" name="id" value="<?= $pro->idProduk ?>" id="">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Type</label>
                                                                    <input class="form-control" type="text" value="<?= $pro->typeProduk ?>" name="typeProduk" placeholder="Nomer KTP" />
                                                                </div>
